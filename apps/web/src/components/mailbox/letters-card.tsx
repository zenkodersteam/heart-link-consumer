 ...
 * by ProfileReviewOverlay in that case, so this card is only ever drawn for
 * someone who can actually spend an allowance.
 */
export function LettersCard() {
  ...
  if (isPending) {
    ...
    return (
      <div className="h-[104px] animate-pulse rounded-card border border-line bg-surface-muted" />
    );
  }
